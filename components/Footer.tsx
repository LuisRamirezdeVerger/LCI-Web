...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-black text-white p-[5%] border-t-2 border-black">
      <div className="max-w-[80rem] mx-auto grid grid-cols-1 md:grid-cols-3 gap-[3rem] text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start gap-[1.2rem]">
          ...
          <p className="text-center mt-[1rem] text-[0.8rem] text-gray-400 max-w-[15rem]">
